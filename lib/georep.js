...
/**
 * Dato il messaggio di errore contenuto nel campo <code>error</code> di un oggetto
 * <code>FailureResponse</code>, stabilisce se l'errore è dovuto all'impossibilità
 * del DNS a tradurre l'hostname in IP.
 * @param {string} err stringa di errore.
 * @returns {boolean} true se l'errore è dovuto al DNS, false altrimenti.
 */
...
/**
 * Dato il messaggio di errore contenuto nel campo <code>error</code> di un oggetto
 * <code>FailureResponse</code>, stabilisce se l'errore è dovuto allo scattare del timeout.
 * @param {string} err stringa di errore.
 * @returns {boolean} true se lo scattare del timeout ha generato l'errore, false atrimenti.
 */
