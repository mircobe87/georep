...
<p>
	Sul database è possibile immagazzinare record georeferenziati che contengono le
	seguenti inforamazioni:
	<ul>
...
<p>
	...
	che specifichi tutte le sue informazioni; tale oggetto deve avere le segueti properties:
	<ul>
...
var User = function (userConf) {
	if (userConfValidator(userConf)){
		/**
		 * Identificatore unico usato dal server per identificare questo utente dagli altri.
		 * @attribute _id
		 * @type string
		 * @readOnly
		 */
		...
		this.type = 'user';
		/**
		 * Ruoli dell'utente sul database
		 * @readOnly
		 * @attribute roles
		 * @type array
		 * @default []
...
<p>
	...
	impiegato, l'indirisso IP o hostname del macchina che ospita il servizio, il
...
<p>
	Per poter registrare un nuovo utene sul database è necessario operare come
...
<p>
	Per poter cominicare con il database e invare query è necessario specificare
...
<p>
	...
	<ul>
		...
		<li>
			se la query è andata a buon fine allora il <b>primo</b> paramerto sarà
 ...
 * <ul>
 *     <li><b><code>lat</code></b> - <i>number</i>: compresto tra -90 e 90 che indica la latitudine <b>nord</b>
 *     <li><b><code>lng</code></b> - <i>number</i>: compresto tra -180 e 180 che indica la longitudine <b>est</b>
 * </ul>
 * Per esempio:
 ...
 * @param {object} user oggetto <code>userConf</code> con i nuovi valori per
